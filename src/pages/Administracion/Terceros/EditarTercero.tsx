...
const EditarTerceroPage = () => {
    ...
    useEffect(() => {
        if (dataTercero) {
            // poner los datos en los inputs por defecto
            console.log(dataTercero)
            setValue("nit", dataTercero.nit)
            setValue("id_municipio", dataTercero.id_municipio)
            setValue("tipo", dataTercero.tipo)
            setValue("primer_apellido", dataTercero.primer_apellido)
            setValue("segundo_apellido", dataTercero.segundo_apellido)
            setValue("primer_nombre", dataTercero.primer_nombre)
            setValue("segundo_nombre", dataTercero.segundo_nombre)
            setValue("razon_social", dataTercero.razon_social)
            setValue("direccion", dataTercero.direccion)
            setValue("telefono", dataTercero.telefono)
            setValue("telefono_movil", dataTercero.telefono_movil)
            setValue("correo", dataTercero.correo)
            setValue("regimenes", dataTercero.regimenes as regimenes)
    ...
    return (
        <MainLayout>
            <main>
                <ContainerLayout>
                    <h1 className="text-2xl font-bold my-4">Editar un Tercero</h1>
