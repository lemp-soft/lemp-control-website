...
interface MainTableHeaderProps {
    columns: { name: string, active: boolean }[]
    setColumns: (columns: { name: string, active: boolean }[]) => void
    haddleSearch: (e: React.ChangeEvent<HTMLInputElement>) => void
}
const MainTableHeader = ({ columns, setColumns,haddleSearch }: MainTableHeaderProps) => {
