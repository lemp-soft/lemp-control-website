...
import { Ciuu } from "../../../types/ciiu";
interface ReducerState {
    ciius: Ciuu[];
    ciiuSearch: string;
}
type ReducerAction = { type: "SET_CIIUS", payload: Ciuu[] } | { type: "SET_CIIUS_SEARCH", payload: string }
...
const SearchActividadEconomica = ({setValue}:Props) => {
    ...
    const { data, isLoading, isError, isFetching, refetch } = useQuery<{ data: Ciuu[], status: string }>({
