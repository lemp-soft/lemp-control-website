...
export function SearchInput<T extends { codigo: number, content: string }>({ isError, isFetching, isLoading, state, handdleSearch, handdleClick, className }: SearchInputProps<T>) {
    return (
        <div className={`col-span-4 z-50 relative mb-2 text-sm font-medium text-gray-900 dark:text-white ${className}`}>
