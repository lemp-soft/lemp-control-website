...
const TercerosPage = () => {
    const { columns, data, isError, isLoading, pagination, setColumnsStore, haddleSearch, handdleEdit, handdleDeleteTercero, handdleClickOnRow } = useTercerosPage()
            ...
            <main>
                <ContainerFullLayout>
                    ...
                    <section className="mt-6">
                        ...
                        <MainTable data={TableData} error={isError} loading={isLoading} haddleEdit={handdleEdit} haddeDelete={handdleDeleteTercero} name="terceros" pagination={pagination} columns={columns} handdleClickOnRow={handdleClickOnRow} />
                    </section>
                </ContainerFullLayout>
            </main>
        </MainLayout>
